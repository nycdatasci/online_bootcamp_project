...
Environmental, monetary and convenience benefits aside, bikeshare programs have embraced the influx of big data collected by their bike/station technology, using the rich datasets collected for their own insights as well as posting many of them to the public for any aspiring data scientist to enjoy.
...
```{r hourly_profile_histogram, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r trips_duration_histogram, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r demographics_histogram, echo=FALSE, message=FALSE, warning=FALSE}
