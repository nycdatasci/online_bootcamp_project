...
light_theme <- function(base_size=12,text_color='gray15'){
    theme(
      ...
      plot.margin = unit(c(1.2,1.2,3,1.2),"lines"),
      axis.ticks = element_line(size=0.15),
      axis.text = element_text(colour=text_color,size=rel(0.6)),
      axis.text.x = element_text(angle = 30),
      axis.title.x = element_text(vjust=-1.2,size=base_size,colour=text_color),
